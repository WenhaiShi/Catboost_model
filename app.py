...
if selected_features is None:
    selected_features = ['Age', 'LOS', 'Weight', 'SOFA', 'RR', 'PH', 'PCO2', 'OI', 'WBC', 'MCHC', 'Calcium', 'INR', 'Chloride', 'Glucose', 'PT', 'ALT', 'Average output urine', 'Beta blocker']
...
- **Laboratory Values**: {', '.join([f for f in selected_features if f in ['WBC', 'MCHC', 'Calcium','INR', 'Chloride', 'Glucose', 'PT', 'ALT']])}
- **Medications & Renal Function**: {', '.join([f for f in selected_features if f in ['Beta blocker', 'Average output urine']])}

**Note**: Beta blocker is a binary variable (Yes/No) indicating whether the patient is receiving beta blocker medication.
""")
